...
public class TeamRoomController {
    ...
    public ResponseEntity<TeamRoomResponse> createQuizRoom(
        ...
        return ResponseEntity.ok(teamRoomService.createQuizRoom(request, httpRequest));
    }
    ...
    public ResponseEntity<TeamRoomResponse> createFocusRoom(
        ...
        return ResponseEntity.ok(teamRoomService.createFocusRoom(request, httpRequest));
    }
    ...
    public ResponseEntity<MessageResponse> startQuiz(@RequestBody TeamRoomUserRequest request, HttpServletRequest httpRequest) {
        teamRoomService.startQuizSession(request, httpRequest);
    ...
    public ResponseEntity<MessageResponse> terminateQuiz(@RequestBody TeamRoomUserRequest request, HttpServletRequest httpRequest) {
        teamRoomService.terminateQuizSession(request, httpRequest);
    ...
    public ResponseEntity<MessageResponse> uploadFailedQuestion(@RequestBody TeamRoomUnsolvedPostRequest request, HttpServletRequest httpRequest) {
        teamRoomService.uploadUnsolvedQuestionPost(request, httpRequest);
    ...
    public ResponseEntity<MessageResponse> completeFocusSession(@RequestBody TeamRoomUserRequest request, HttpServletRequest httpRequest) {
        teamRoomService.completeFocusSession(request, httpRequest);
